...
WORKFLOWS = {
    ...
    "ppg": ["PPG_assess_quality", "Signal_detect_artifacts", "PPG_detect_peaks", "PPG_assess_perfusion_variability"],
    "bcg": ["BCG_assess_quality", "Signal_detect_artifacts", "BCG_detect_j_peaks"],
    "scg": ["SCG_assess_quality", "Signal_detect_artifacts", "SCG_detect_j_peaks"],
    ...
    "pcg": ["PCG_assess_quality", "Signal_detect_artifacts", "PCG_detect_heart_sounds", "PCG_screen_murmur_proxy"],
    "acc": ["ACC_assess_quality", "Signal_detect_artifacts", "ACC_summarize_activity", "ACC_estimate_sleep_wake"],
    "eda": ["EDA_assess_quality", "Signal_detect_artifacts", "EDA_summarize", "EDA_detect_arousal_events"],
    "eeg": ["EEG_assess_quality", "Signal_detect_artifacts", "EEG_compute_bandpower", "EEG_estimate_sleep_stage_features", "EEG_screen_seizure_like_activity"],
    "emg": ["EMG_assess_quality", "Signal_detect_artifacts", "EMG_summarize_activation", "EMG_estimate_fatigue"],
}
