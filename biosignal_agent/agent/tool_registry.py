...
from biosignal_agent.tools.eeg_tools import EEG_assess_quality, EEG_classify_sleep_stage_ml, EEG_detect_artifact_proxy, EEG_estimate_drowsiness, EEG_estimate_sleep_stage_features, EEG_screen_seizure_like_activity, EEG_screen_seizure_ml
from biosignal_agent.tools.emg_tools import EMG_analyze_gait_activation, EMG_assess_quality, EMG_classify_action, EMG_classify_gait_speed, EMG_classify_gesture, EMG_classify_prosthetic_gesture, EMG_classify_lower_limb_exercise, EMG_classify_physical_action, EMG_estimate_fatigue, EMG_estimate_fatigue_ml, EMG_estimate_gait_phase, EMG_predict_movement_intent, EMG_screen_knee_rehab_status, EMG_screen_neuromuscular_abnormality, EMG_summarize_activation
from biosignal_agent.tools.pcg_tools import PCG_assess_quality, PCG_assess_rhythm_irregularity, PCG_detect_heart_sounds, PCG_detect_s3_s4_proxy, PCG_estimate_heart_rate, PCG_extract_murmur_features, PCG_monitor_heart_function_proxy, PCG_screen_congenital_abnormality_proxy, PCG_screen_murmur_patient_multisite, PCG_screen_murmur_proxy, PCG_screen_valve_disease_proxy
from biosignal_agent.tools.ppg_tools import PPG_assess_quality, PPG_assess_perfusion_variability, PPG_assess_stress_prv, PPG_assess_vascular_health, PPG_compute_prv, PPG_detect_afib, PPG_detect_fiducial_points, PPG_estimate_bp_proxy, PPG_estimate_exercise_intensity, PPG_estimate_heart_rate, PPG_estimate_respiration_modulation, PPG_estimate_sleep_features, PPG_estimate_spo2, PPG_screen_low_perfusion_shock_risk, PPG_screen_pulse_irregularity
from biosignal_agent.tools.resp_tools import RESP_assess_quality, RESP_detect_breath_peaks, RESP_estimate_rate, RESP_screen_rate_pattern, RESP_screen_sleep_apnea_ml, RESP_summarize_event_burden
from biosignal_agent.tools.scg_tools import SCG_assess_quality, SCG_assess_sensor_placement, SCG_compute_cardiac_time_intervals, SCG_detect_fiducial_points, SCG_estimate_contractility_proxy, SCG_estimate_respiration, SCG_screen_mechanical_abnormality
from biosignal_agent.tools.spo2_tools import SpO2_assess_hypoxemia_burden, SpO2_assess_quality, SpO2_detect_peaks_troughs, SpO2_extract_oximetry_features, SpO2_screen_sleep_apnea_ml, SpO2_screen_sleep_apnea_oximetry, SpO2_summarize
...
WORKFLOWS = {
    ...
    "scg": ["SCG_assess_quality", "Signal_detect_artifacts", "SCG_assess_sensor_placement", "SCG_detect_fiducial_points", "SCG_compute_cardiac_time_intervals", "SCG_estimate_contractility_proxy", "SCG_estimate_respiration", "SCG_screen_mechanical_abnormality"],
    "resp": ["RESP_assess_quality", "Signal_detect_artifacts", "RESP_detect_breath_peaks", "RESP_estimate_rate", "RESP_screen_sleep_apnea_ml", "RESP_screen_rate_pattern", "RESP_summarize_event_burden"],
    "multimodal": ["Multimodal_estimate_ecg_ppg_pat_bp_proxy", "Multimodal_screen_sleep_apnea_report"],
    "spo2": ["SpO2_assess_quality", "Signal_detect_artifacts", "SpO2_detect_peaks_troughs", "SpO2_summarize", "SpO2_assess_hypoxemia_burden", "SpO2_extract_oximetry_features", "SpO2_screen_sleep_apnea_oximetry", "SpO2_screen_sleep_apnea_ml"],
