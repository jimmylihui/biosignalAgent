...
DEFAULT_PLANNING_CASES = [
    ...
    PlanningCase(
        ...
        modality='ecg',
        expected_tools=('ECG_assess_quality', 'ECG_compute_hrv'),
    ),
    PlanningCase(
        case_id='ecg_r_peaks',
    ...
    PlanningCase(
        ...
        modality='ecg',
        expected_tools=('ECG_assess_quality', 'ECG_compute_hrv', 'ECG_screen_arrhythmia'),
    ),
    PlanningCase(
    ...
    PlanningCase(
        ...
        modality='eeg',
        expected_tools=('EEG_assess_quality', 'EEG_estimate_sleep_stage_features'),
    ),
    PlanningCase(
    ...
    PlanningCase(
        ...
        modality='ecg',
        expected_tools=('ECG_assess_quality', 'ECG_compute_hrv', 'ECG_screen_sleep_apnea'),
    ),
    ...
    PlanningCase(
        ...
        modality='ppg',
        expected_tools=('PPG_assess_quality', 'PPG_assess_perfusion_variability'),
    ),
    PlanningCase(
        ...
        modality='ppg',
        expected_tools=('PPG_assess_quality', 'PPG_assess_perfusion_variability', 'PPG_screen_pulse_irregularity'),
    ),
    PlanningCase(
    ...
    PlanningCase(
        ...
        modality='eeg',
        expected_tools=('EEG_assess_quality', 'EEG_screen_seizure_like_activity'),
    ),
    PlanningCase(
    ...
    PlanningCase(
        ...
        modality='ecg',
        expected_tools=('ECG_assess_quality', 'ECG_measure_morphology_intervals'),
    ),
    PlanningCase(
    ...
    PlanningCase(
        ...
        modality='ppg',
        expected_tools=('PPG_assess_quality', 'PPG_estimate_respiration_modulation'),
    ),
    PlanningCase(
    ...
    PlanningCase(
        ...
        modality='eeg',
        expected_tools=('EEG_assess_quality', 'EEG_estimate_drowsiness'),
    ),
    PlanningCase(
